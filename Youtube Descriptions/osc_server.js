...
function getChaptersUrl() {
    ...
    return `https://raw.githubusercontent.com/TheCathedralFCCLA/tech-info/${branch}/Youtube%20Descriptions/chapters.txt`;
}
...
async function pushTimingsToGithub() {
    ...
    const apiUrl = "https://api.github.com/repos/TheCathedralFCCLA/tech-info/contents/Youtube%20Descriptions/timings.txt";
...
async function checkGitHubActionStatus(pat, attempts = 0) {
    ...
    try {
        const url = "https://api.github.com/repos/TheCathedralFCCLA/tech-info/actions/runs?event=push&per_page=5";
